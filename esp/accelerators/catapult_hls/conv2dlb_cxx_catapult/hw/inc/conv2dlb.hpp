...
#ifndef __CONV2DLB_CXX_HPP__
#define __CONV2DLB_CXX_HPP__
...
#define N_W_OUT_MAX 5
#define N_H_OUT_MAX 5

#define INPUTS_SIZE_MAX 147
#define KERNEL_SIZE_MAX 9
#define OUTPUTS_SIZE_MAX 75
*/
#define BATCH_MAX 16
...
typedef plm_t<FPDATA_IN, KERNEL_SIZE_MAX> plm_kernel_t;
...
typedef buf_t<FPDATA_IN, KERN_MAX, N_W_IN_MAX> buf_lin_t;
