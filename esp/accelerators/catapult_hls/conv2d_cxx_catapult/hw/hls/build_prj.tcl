...
# Add source files.
solution file add ../src/$uarch/conv2d.cpp -type C++
solution file add ../inc/conv2d.hpp -type C++
solution file add ../tb/main.cpp -type C++ -exclude true

solution file set ../src/$uarch/conv2d.cpp -args -DDMA_WIDTH=$DMA_WIDTH
solution file set ../inc/conv2d.hpp -args -DDMA_WIDTH=$DMA_WIDTH
